...
for (let i = 0; i < inventory.length; i++) {
  ...
  if (carModels[i].charAt(0) === carModels[i].charAt(0).toLowerCase()) {
  carModels[i] = carModels[i].replace(/^[a-z]/, (u) => u.toUpperCase());
  } 
...
console.log(`These are all the BMW and Audi cars in the lot: `+ JSON.stringify(BMWAndAudi));
